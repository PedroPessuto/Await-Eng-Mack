        ...
        <NavigationMenu>
          <NavigationMenuList>
            ...
            <NavigationMenuItem>
              ...
              >
                  <NavigationMenuLink
                   href="/painel/membros/atividades"
                    className={cn(
                      navigationMenuTriggerStyle(),
            ...
            <NavigationMenuItem>
              <div
                className={`py-1.5 ${section === 'cargos' && 'border-primary border-b-2'}`}
              >
                  <NavigationMenuLink
                  href="/painel/membros/cargos" 
                    className={cn(
                      navigationMenuTriggerStyle(),
                      `${section === 'cargos' && 'bg-primary/10 hover:bg-primary/10 focus:bg-primary/10'}`
                    )}
                  >
                    Cargos
                  </NavigationMenuLink>
